const STORAGE_KEY = 'fit-ui-state-v6_8';
...
const courses = [
  { id: 1, day: 'Mo 9', dateLabel: 'Mo., 09. März', time: '17:50', duration: 55, title: "Indoor Cycling 55'", instructor: 'Maria-Lena W.', location: 'BodyCue Luzern', spots: 2, booked: false },
  { id: 2, day: 'Mo 9', dateLabel: 'Mo., 09. März', time: '18:10', duration: 55, title: "BODYATTACK® 55'", instructor: 'Fabian M.', location: 'BodyCue Luzern', spots: 0, booked: false },
  { id: 3, day: 'Mo 9', dateLabel: 'Mo., 09. März', time: '19:00', duration: 55, title: "Indoor Cycling 55'", instructor: 'Anne-Sophie M.', location: 'BodyCue Luzern', spots: 0, booked: true },
  { id: 4, day: 'Di 10', dateLabel: 'Di., 10. März', time: '07:35', duration: 25, title: "CORE® 25'", instructor: 'Sandra K.', location: 'BodyCue Luzern', spots: 10, booked: false },
  { id: 5, day: 'Mo 9', dateLabel: 'Mo., 09. März', time: '19:10', duration: 55, title: "BODYPUMP® 55'", instructor: 'Laura M.', location: 'BodyCue Luzern', spots: 0, booked: false },
];
  ...
  screens.home.innerHTML = `
    <header class="hero-header red compact-header">
      ...
      <div class="hero-title-wrap">
        ...
        <div class="logo-mark">Body<br/><span>Cue</span></div>
      </div>
    </header>
...
function renderAccount() {
  screens.account.innerHTML = `
    ...
    <section class="panel">
      <article class="card" style="background:linear-gradient(120deg,#ff1218,#ff5a5f);color:#fff"><strong>Zum BodyCue Memberbereich</strong></article>
